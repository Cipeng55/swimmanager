          ...
          <table className="min-w-full text-sm border-collapse border border-gray-300 dark:border-gray-600">
            <thead className="bg-gray-100 dark:bg-gray-700">
              <tr>
                ...
                <th className="px-3 py-2 text-left font-medium text-gray-600 dark:text-gray-300 border border-gray-300 dark:border-gray-600">{isSchoolLevelSystem ? 'Club / Instansi' : 'Club'}</th>
